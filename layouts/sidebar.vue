...
//         method: "GET",
//         uri_component:
//           "https://mock-app-2h5z.onrender.com/eea31c8d-5b83-44d8-bc79-e2a0e732f335/api/user",
...
const createMockServer = async (newapi: object, collection_name: string) => {
  ...
  const { data: status } = await useFetch(
    "https://mock-app-2h5z.onrender.com/mock-api/new",
    {
      method: "POST",
      mode: "cors",
      headers: { "Content-type": "application/json" },
  ...
  if (status1.status) {
    ...
    if (await createMockApi(api)) {
      ...
      const url = "https://mock-app-2h5z.onrender.com/" + collection.id;
